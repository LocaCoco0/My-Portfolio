...
//const cupcakeImg = document.getElementById("featured-cupcake-img");
function showFlavorOfDay() {

  const cupcakeImg = document.getElementById("featured-cupcake-img");

  img = findFlavorObject().img;
  cupcakeImg.setAttribute("src", img);
}

document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("featured-cupcake-img").onclick = showFlavorOfDay();
});
